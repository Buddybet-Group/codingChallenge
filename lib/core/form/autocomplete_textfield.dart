...
class AutoCompleteTextField<T> extends StatefulWidget {
  ...
  final bool? submitOnSuggestionTap, clearOnSubmit, showAll;
...
class AutoCompleteTextFieldState<T> extends State<AutoCompleteTextField> {
  ...
  int? minLength;
  bool? submitOnSuggestionTap, clearOnSubmit, showAll;
  ...
  Widget _suggessionBuilder(dynamic width) {
        ...
        if(controller!.text != '') {
          return new Positioned(
              ...
              child: CompositedTransformFollower(
                  ...
                  child: _suggessionBuilder(width)
              ));
        }else {
          if(showAll! && textField!.focusNode!.hasFocus) {
              return new Positioned(
                width: width,
                child: CompositedTransformFollower(
                  link: _layerLink,
