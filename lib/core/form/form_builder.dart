...
class FormBuilderState extends State<FormBuilder> {
  ...
  registerFieldKey(String? attribute, GlobalKey key) {
    ...
    this._fieldKeys![attribute] = key as GlobalKey<FormFieldState<dynamic>>;
  }
...
//    print(this._fieldKeys[attribute]);
//    if (this._fieldKeys[attribute] != null){
//      print("Current $attribute value: ${this._fieldKeys[attribute].currentState.value}");
//      print("Trying to change $attribute to $newValue");
//      this._fieldKeys[attribute].currentState.didChange(newValue);
//      print("$attribute value after: ${this._fieldKeys[attribute].currentState.value}");
//    }
//  }
