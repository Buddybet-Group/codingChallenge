...
// import '../custom_packages/datetime_picker_formfield.dart';
...
class _FormBuilderDateTimePickerState extends State<FormBuilderDateTimePicker> {
  ...
  void initState() {
    ...
    if (widget.initialValue != null &&
        widget.initialValue != DateTime.parse('-0001-11-30 00:00:00.000')) {
    ...
    return DateTimeField(
      ...
      onShowPicker: (BuildContext? context, DateTime? currentValue) async {
        switch (widget.inputType) {
          case InputType.date:
            return DateTimeField.convert(await _showDatePicker(
                context, currentValue!, widget.initialTime!));
          case InputType.time:
            return DateTimeField.convert(await _showTimePicker(
                context!, currentValue!, widget.initialTime!));
          case InputType.both:
  ...
  Future _showDatePicker(
      BuildContext? context, DateTime? currentValue, TimeOfDay? initialTime) {
            ...
            data: ThemeData.dark().copyWith(
              timePickerTheme: TimePickerThemeData(
                  dayPeriodBorderSide: BorderSide(
                      width: 0.5, style: BorderStyle.solid, color: Colors.grey),
                  dialBackgroundColor: Color(0xffDADADA)),
              primaryTextTheme: Typography().tall,
              colorScheme: ColorScheme.dark(
